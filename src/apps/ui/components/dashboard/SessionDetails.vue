...
const deleteALogLoading = ref(false);
...
function clearDataAndDismissAddAExerciseModal() {
  ...
  modal.hide();
  window.setTimeout(() => {
    addAExerciseShowAllExercises.value = false;
  }, 300);
}
...
async function deleteALog() {
  try {
    deleteALogLoading.value = true;
...
function clearAndDismissDeleteALogModal() {
              ...
              <span class="m-0 p-0" v-auto-animate>
                ...
                <span class="card-title d-flex justify-content-between align-items-center m-0 p-0">
                  ...
                  <span class="d-flex justify-content-between gap-3 align-items-center">
                    ...
                    <!-- lock a video -->
                    <!-- <span v-if="appStore.community" @click="
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p class="mb-0 pb-0 text-center">
            ...
            <span class="badge bg-secondary text-white">{{ deleteALogLogObject?.name }}</span>
            ?
          </p>
        </div>
        ...
        <div class="modal-footer">
          ...
          <!-- confirm -->
          <button type="submit" class="btn btn-dark" :disabled="deleteALogLoading">
    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <!-- confirm -->
          <button type="submit" class="btn btn-dark" :disabled="deleteCurrentSessionLoading">
            <div
              v-if="deleteCurrentSessionLoading"
    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <!-- add -->
          <button type="submit" class="btn btn-dark" :disabled="addATagLoading">
