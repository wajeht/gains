<template>
  ...
  <p>
    At AllKindsOfGains, accessible from https://www.allkindsofgains.app/, one of our main priorities
    is the privacy of our visitors. This Privacy Policy document contains types of information that
    is collected and recorded by AllKindsOfGains and how we use it.
  </p>
  ...
  <p>
    ...
    website with regards to the information that they shared and/or collect in AllKindsOfGains. This
  ...
  <p>
    AllKindsOfGains follows a standard procedure of using log files. These files log visitors when
  ...
  <p>
    Like any other website, AllKindsOfGains uses 'cookies'. These cookies are used to store
  ...
  <p>
    ...
    that are used in their respective advertisements and links that appear on AllKindsOfGains, which
  ...
  <p>
    Note that AllKindsOfGains has no access to or control over these cookies that are used by
  ...
  <p>
    AllKindsOfGains's Privacy Policy does not apply to other advertisers or websites. Thus, we are
  ...
  <p>
    AllKindsOfGains does not knowingly collect any Personal Identifiable Information from children
