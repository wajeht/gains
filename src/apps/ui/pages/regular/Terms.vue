<template>
  <div class="px-4">
    ...
    <p>
      This website is operated by AllKindsOfGains. Throughout the site, the terms “we”, “us” and
      “our” refer to AllKindsOfGains. AllKindsOfGains offers this website, including all
    ...
    <p>
      ...
      of content. Please read these Terms of Service carefully before accessing or using our
      website. By accessing or using any part of the site, you agree to be bound by these Terms of
      Service. If you do not agree to all the terms and conditions of this agreement, then you may
      not access the website or use any services. If these Terms of Service are considered an offer,
    ...
    <p>
      ...
      the posting of any changes constitutes acceptance of those changes. Our store is hosted on
    ...
    <p>
      ...
      any color will be accurate. We reserve the right, but are not obligated, to limit the sales of
      our products or Services to any person, geographic region or jurisdiction. We may exercise
    ...
    <p>
      ...
      restrictions may include orders placed by or under the same customer account, the same credit
      card, and/or orders that use the same billing and/or shipping address. In the event that we
      make a change to or cancel an order, we may attempt to notify you by contacting the e-mail
      ...
      resellers or distributors. You agree to provide current, complete and accurate purchase and
      account information for all purchases made at our store. You agree to promptly update your
    ...
    <p>
      ...
      objectionable or violates any party’s intellectual property or these Terms of Service. You
    ...
    <p>
      ...
      services delivered to you through the service are (except as expressly stated by us) provided
      'as is' and 'as available' for your use, without any representation, warranties or conditions
      ...
      and non-infringement. In no case shall AllKindsOfGains, our directors, officers, employees,
      ...
      in any way to your use of the service or any product, including, but not limited to, any
      errors or omissions in any content, or any loss or damage of any kind incurred as a result of
      the use of the service or any content (or product) posted, transmitted, or otherwise made
    ...
    <p>
      You agree to indemnify, defend and hold harmless AllKindsOfGains and our parent, subsidiaries,
    ...
    <p>
      ...
      our Services, or when you cease using our site. If in our sole judgment you fail, or we
      suspect that you have failed, to comply with any term or provision of these Terms of Service,
      we also may terminate this agreement at any time without notice and you will remain liable for
      all amounts due up to and including the date of termination; and/or accordingly may deny you
    ...
    <p>
      ...
      limited to, any prior versions of the Terms of Service). Any ambiguities in the interpretation
    ...
    <p>
      ...
      governed by and construed in accordance with the laws of Augusta, GA, 30909, United States.
    </p>
